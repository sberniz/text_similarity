...
test2 = "hello how are you."
test3 = "goodbye everyone. for the best points Rewards ever"
...
print(similarity(test1,test2))
print(similarity(test1,test3))
print(similarity(sample1,sample2))
print(similarity(sample1,sample3))